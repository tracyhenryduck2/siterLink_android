...
public class DeviceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener, View.OnLongClickListener  {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof MyViewHolder){
            ...
            if(TextUtils.isEmpty(datas.get(position).getBindKey())){
                ((MyViewHolder) holder).share_iv.setVisibility(View.VISIBLE);
                ((MyViewHolder) holder).share_iv.setImageResource(R.drawable.sharing);
            }else{
                ((MyViewHolder) holder).share_iv.setVisibility(View.GONE);
            }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(View view)
        {
            ...
            share_iv = (ImageView)view.findViewById(R.id.shareicon);
        }
    }
