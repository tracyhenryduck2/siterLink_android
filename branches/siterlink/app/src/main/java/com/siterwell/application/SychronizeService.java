            ...
            public void succuss(List<DeviceBean> deviceBeans) {
                try {
                    ...
                    for(int i=0;i<deviceBeans.size();i++){
                        ...
                        String name = deviceBeans.get(i).getDeviceName();
                        if(DeviceType.BATTERY.toString().equals(deviceBeans.get(i).getModel())){
                        ...
                        }else if(DeviceType.WIFISOKECT.toString().equals(deviceBeans.get(i).getModel())){
                            name = name.replaceAll("WIFI插座-",(getResources().getString(R.string.socket)+"-"));
                        }else if(DeviceType.WATERSENEOR.toString().equals(deviceBeans.get(i).getModel())){
                            name = name.replaceAll("siterLink-",(getResources().getString(R.string.watersensor)+"-"));
                        }
                        deviceBeans.get(i).setDeviceName(name);
                    }
