...
import com.siterwell.application.folder.configuration.EsptouchAnimationActivity;
    ...
    private void initView(){
        ...
        getTopBarView().setTopBarStatus(R.drawable.back, -1, getResources().getString(R.string.add_battery_instruct), 1, new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(SocketGuide1Activity.this,ConfigurationActivity.class);
                i.putExtra("devicetype", DeviceType.WIFISOKECT.toString());
                startActivity(i);
                finish();
            }
        },null,R.color.bar_bg);
        imageView = (ImageView)findViewById(R.id.guide_water);
        imageView.setBackgroundResource(R.drawable.config_socket);
