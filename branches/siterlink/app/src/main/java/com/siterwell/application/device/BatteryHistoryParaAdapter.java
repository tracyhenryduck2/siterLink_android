 ...
 */
public class BatteryHistoryParaAdapter extends BaseAdapter {
    private Context mContext;
    private List<WarningHistoryBean> mLists;

    public BatteryHistoryParaAdapter(Context context, List<WarningHistoryBean> lists ){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
       ...
       holder.pot.setImageResource(BatteryDescBean.getStatusColor(mLists.get(position).getWarningsubject()));
       holder.contentView.setText(BatteryDescBean.getStatusString(mLists.get(position).getWarningsubject()));
        return convertView;
    }
