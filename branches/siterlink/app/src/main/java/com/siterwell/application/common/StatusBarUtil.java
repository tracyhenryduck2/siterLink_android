...
public class StatusBarUtil {
    ...
    public static void setDefaultStatus(Activity activity){
        StatusBarUtil.setColor(activity, ContextCompat.getColor(activity, R.color.white), true);
     ...
     * @param color    状态栏颜色值
     */
    public static void setColor(Activity activity, @ColorInt int color, boolean root) {
        setColor(activity, color, DEFAULT_STATUS_BAR_ALPHA, root);
    }
     ...
     */
    public static void setColor(Activity activity, @ColorInt int color, @IntRange(from = 0, to = 255) int statusBarAlpha, boolean root) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            activity.getWindow().clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
            activity.getWindow().setStatusBarColor(calculateStatusColor(color, statusBarAlpha));
            if (root) setRootView(activity);
        } else {
            setTranslucent(activity, 128);
        }
    }
    ...
    public static void setColorNoTranslucent(Activity activity, @ColorInt int color) {
        setColor(activity, color, 0, true);
    }
